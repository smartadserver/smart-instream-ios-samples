...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Configure Equativ Instream SDK with your SiteID
        ...
        // Equativ Instream SDK will retrieve the TCF consent string from the NSUserDefaults using the official IAB key "IABTCF_TCString"
        /////////////////////////////////////////
        // If you are using a CMP that is not validated by the IAB or not using the official key:
        // you will have to manually store the computed consent string into the NSUserDefaults for Equativ Instream SDK to retrieve it and forward it to its partners.
        /////////////////////////////////////////
        ...
        // Equativ Instream SDK will retrieve the CCPA consent string from the NSUserDefaults using the official IAB key "IABUSPrivacy_String"
        /////////////////////////////////////////
        // If you are using a CMP that is not validated by the IAB or not using the official key:
        // you will have to manually store the computed consent string into the NSUserDefaults for Equativ Instream SDK to retrieve it and forward it to its partners.
        /////////////////////////////////////////
