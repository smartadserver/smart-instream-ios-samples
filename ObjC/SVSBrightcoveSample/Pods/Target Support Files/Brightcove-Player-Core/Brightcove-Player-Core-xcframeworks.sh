...
install_xcframework "${PODS_ROOT}/Brightcove-Player-Core/ios/dynamic/BrightcovePlayerSDK.xcframework" "Brightcove-Player-Core/XCFramework" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
